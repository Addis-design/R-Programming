...
intercept_original <- 2.431
coef_ppg_original <- 0.742
coef_rpg_original <- 0.102

# Convert PPG to TotalPoints by dividing by the number of games
adjusted_coef_ppg <- coef_ppg_original / 82

# Display the adjusted coefficient on TotalPoints
cat("Adjusted Coefficient on TotalPoints:", adjusted_coef_ppg, "\n")
#Question 4
#4 a
